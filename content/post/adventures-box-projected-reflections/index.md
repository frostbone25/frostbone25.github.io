...
![Standard Cubemap Reflection with Box Projection](compare-a-none.png)
...
![Box Projected Cubemap Reflection with approximated Contact Hardening](compare-a-approx2.png)
...
![Box Projected Cubemap Reflection with approximated Contact Hardening (HDRP Approximation)](compare-a-approx-hdrp.png)
...
![Box Projected Cubemap Reflection with Raytracing](compare-a-raytrace.png)
...
![None](compare-a-none.png) ![Approximated](compare-a-approx2.png) ![HDRP Approximation](compare-a-approx-hdrp.png) ![Raytraced](compare-a-raytrace.png)

### Contact Hardening Comparisons (Normal Mapped Material)

![None](compare-b-none.png) ![Approximated](compare-b-approx2.png) ![HDRP Approximation](compare-b-approx-hdrp.png) ![Raytraced](compare-b-raytrace.png)
...
![Static White Noise](raytrace-1-whitenoise.png) ![Static Blue Noise](raytrace-2-bluenoise.png)
...
![Static Blue Noise](raytrace-2-bluenoise.png) ![Static Blue Noise With Mip Offsetting](raytrace-3-mip-cheat.png)

#### Animated Noise *(Non-Deterministic Sampling)*

![Animated White Noise](raytrace-7-white-noise-animate.png) ![Animated Blue Noise](raytrace-6-blue-noise-animate.png)
...
![Deterministic Sampling](raytrace-4-deterministic.png) ![Deterministic Sampling With Mip Offset](raytrace-5-mip-cheat.png)
